...
from main.views import main_page, index_page, second_page, user_login, register, user_logout, create_event, accept_friend_request, reject_friend_request,send_friend_request, friends_view, remove_friend
